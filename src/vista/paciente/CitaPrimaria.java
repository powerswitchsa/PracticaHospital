	...
	public CitaPrimaria(Color colorFondo, int letraPequena, int letraGrande, String tipoLetra) {
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(panelComboMedico, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 506, Short.MAX_VALUE)
								.addComponent(panelComboPaciente, GroupLayout.DEFAULT_SIZE, 506, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(panelComboId, GroupLayout.PREFERRED_SIZE, 153, GroupLayout.PREFERRED_SIZE)
							.addGap(61))))
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(26)
					.addComponent(lblTitulo, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
					.addGap(26)
					...
					.addComponent(panelComboMedico, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
					.addGap(54)
					.addComponent(panelDias, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelBotonera, GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
					.addGap(36))
		);
		...
		gl_panelComboId.setHorizontalGroup(
			gl_panelComboId.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboId.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(comboID, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(30, Short.MAX_VALUE))
		);
		gl_panelComboId.setVerticalGroup(
			gl_panelComboId.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboId.createSequentialGroup()
		...
		gl_panelComboPaciente.setHorizontalGroup(
			gl_panelComboPaciente.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboPaciente.createSequentialGroup()
					...
					.addGap(43)
					.addComponent(comboPaciente, 0, 382, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panelComboPaciente.setVerticalGroup(
			gl_panelComboPaciente.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboPaciente.createSequentialGroup()
					.addGroup(gl_panelComboPaciente.createParallelGroup(Alignment.LEADING)
						.addComponent(lblPaciente, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
						.addComponent(comboPaciente, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		...
		gl_panelComboMedico.setHorizontalGroup(
			gl_panelComboMedico.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboMedico.createSequentialGroup()
					.addComponent(lblMedico, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
					.addGap(44)
					.addComponent(comboMedico, 0, 381, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panelComboMedico.setVerticalGroup(
			gl_panelComboMedico.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelComboMedico.createSequentialGroup()
